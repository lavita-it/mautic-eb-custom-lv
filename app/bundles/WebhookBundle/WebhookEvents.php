...
final class WebhookEvents
{
    ...
    /**
     * The mautic.webhook.campaign_on_webhook_response event is dispatched when send a webhook campaign action is fired.
     *
     * The event listener receives a
     * Mautic\CampaignBundle\Event\CampaignTriggerEvent instance.
     *
     * @var string
     */
    const ON_WEBHOOK_RESPONSE = 'mautic.webhook.campaign_on_send_webhook';
}